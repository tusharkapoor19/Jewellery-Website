        ...
        <div className="shipping-container">
          ...
          <section className="shipping-section">
            ...
            <p>
              ...
              {" "}after successful payment confirmation. Customized or
              made-to-order jewellery may require additional processing time.
            </p>
          </section>
          ...
          <section className="shipping-section">
            ...
            <p>
              We offer <strong>free standard shipping</strong> on eligible
              orders across India. Any applicable shipping charges for express
              delivery or remote locations will be displayed during checkout
          ...
          <section className="shipping-section">
            ...
            <p>
              ...
              confirmation email and SMS containing your tracking details. You
              can monitor your shipment using the provided tracking number.
            </p>
          </section>
          ...
          <section className="shipping-section">
            ...
            <p>
              ...
              please contact our support team within <strong>48 hours</strong>
              {" "}of delivery. In the rare event that a shipment is lost in
              transit, we will investigate the matter with our logistics
              partner.
            </p>
          </section>
          ...
          <section className="shipping-section">
            ...
            <p>
              ...
              while placing an order. HIRANYA will not be responsible for
          ...
          <section className="shipping-section">
            ...
            <p>
              ...
              the package cannot be delivered, it may be returned to us.
          ...
          <section className="shipping-section">
            ...
            <p>
              HIRANYA reserves the right to update or modify this Shipping
              Policy at any time. Changes will be reflected on this page and
